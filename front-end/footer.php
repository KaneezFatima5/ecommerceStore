<footer class="section-t-space">
    ...
    <div class="container-fluid-lg">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="footer-logo">
                        <div class="theme-logo">
                            <a href="index.php">
                                <img src="../assets/images/logo/Art.png" style="width: 200px;" class="blur-up lazyload" alt="">
                            </a>
                        </div>
                        ...
                        <div class="footer-logo-contain">
                            ...
                            <ul class="address">
                                <li>
                                    ...
                                    <a href="javascript:void(0)">Aptech Learning Pakistan</a>
                                </li>
                                <li>
                                    <i data-feather="mail"></i>
                                    <a href="javascript:void(0)">mowais3103@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-xl col-lg-2 col-sm-3">
                    ...
                    <div class="footer-contain">
                        <ul>
                            ...
                            <li>
                                <a href="index.php" class="text-content">Shop</a>
                            </li>
                            <li>
                                <a href="Contauct_Us.php" class="text-content">About Us</a>
                            </li>
                            <li>
                                <a href="index.php" class="text-content">Product</a>
                            </li>
                            <li>
                                <a href="Contact_Us.php" class="text-content">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-sm-3">
                    ...
                    <div class="footer-contain">
                        <ul>
                            ...
                            <li>
                                <a href="cart.php" class="text-content">Carts</a>
                            </li>
                            <li>
                                <a href="login.php" class="text-content">Login</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <li>
                                <div class="footer-number">
                                    ...
                                    <div class="contact-number">
                                        <h6 class="text-content">Aptech</h6>
                                        <h5>03073999594</h5>
                                    </div>
                                </div>
                            </li>
        ...
        <div class="sub-footer section-small-space">
            <div class="reserve">
                <h6 class="text-content">©2023 Art Shopping All rights reserved</h6>
            </div>
