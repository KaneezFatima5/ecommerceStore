    ...
    <section class="wishlist-section section-b-space">
        <div class="container-fluid-lg">
            <div class="row g-sm-3 g-2">
                ...
                $get_wishlist=$wishlist->selectWishlistbycustomer($wishid);
                while($wish_list=$get_wishlist->fetch_array()){
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            ...
                            <a href="Product_Detail.php?pids=<?php echo $wish_list["ProductID"] ?>">
                                    <img src="../back-end/<?php echo $wish_list["ProductImg"] ?>" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <a  href="wishlist.php?remove_from_wishlist=<?php echo $wish_list['WishlistId'] ?>">
                        ...
                        <div class="product-footer">
                            <div class="product-detail">
                                <span class="span-name"><?php echo $wish_list["CatName"]?></span>
                               
                                    <h5 class="name"><?php echo $wish_list["ProductName"]?></h5>
                                
                                <h6 class="unit mt-1"><h5> Sale Price : <?php echo $wish_list["SalePrice"]?></h5></h6>
                                <h5 class="price">
                                    <span class="theme-color">Actual Price :</span>
                                    <del class="theme-color"><?php echo $wish_list["ProductPrice"]?></del>
                                </h5>
<hr>
                                <div class="add-to-cart-box  text-center mt-2">
                                <a class="btn btn-secondary" href="wishlist.php?pid_from_wishlist=<?php echo $wish_list['ProductID'] ?>">
    ...
    <footer class="section-t-space">
        <div class="container-fluid-lg">
            ...
            <div class="sub-footer section-small-space">
                <div class="reserve">
                    <h6 class="text-content">©2022 Art shopping Store All rights reserved</h6>
                </div>
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Mar 2023 19:56:17 GMT -->
</html>