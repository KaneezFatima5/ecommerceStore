...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/product-left-thumbnail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Mar 2023 19:56:04 GMT -->
...
<body>
    ...
    $product = new Product();
    $st = $product->SelectProduct(@$_GET["pids"]);
                        ...
                        <div class="row g-4">
                                            ...
                                            <div class="product-main-2 no-arrow">
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="../back-end/<?php echo $rows["ProductImg"] ?>" id="img-1" data-zoom-image="../assets/images/product/category/1.jpg" class="img-fluid image_zoom_cls-0 blur-up lazyload" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="right-box-contain">
                                    ...
                                    <h2 class="name"><?php echo $rows["ProductName"] ?></h2>
                                    <div class="price-rating">
                                        <h3 class="theme-color price"> <b id="prices"> <?php echo $rows["SalePrice"] ?></b> <del class="text-content"><?php echo $rows["ProductPrice"] ?></del> </h3>
                                        <div class="product-rating custom-rate">
                                            ...
                                            @$_SESSION["proid"] = $rows["ProductID"];
                                            $rp = new rating_product();
                                            $fr = $rp->fetchrating($rows["ProductID"]);
                                            ...
                                            <!-- rating -->
                                            <span class="review"><?php echo $numRating ?> overall Review </span>
                                    ...
                                    <div class="note-box product-packege">
                                        <div class="cart_qty qty-box product-qty">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control input-number qty-input" id="val" onchange="prices.innerHTML=this.value*<?php echo $rows['SalePrice'] ?>" type="number" name="quantity" value="0">

                                            </div>
                                        </div>

                                        <button onclick="location.href = 'Product_Detail.php?pidss=<?php echo $rows['ProductID'] ?>';" class="btn btn-md bg-dark cart-button text-white w-100"> Add To Cart</button>
                                    </div>

                                    <div class="buy-box">
                                        <a href="Product_Detail.php?wish=<?php echo $rows['ProductID'] ?>" class="notifi-wishlist">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <form method="post">
                                                        <div class="row g-4">
                                                            ...
                                                            <input type="hidden" name="txtproductid" class="form-control" required id="review1" value="<?php echo $rows['ProductID'] ?>">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-floating theme-form-floating">
                                                                    <textarea class="form-control" name="txtmsg" required placeholder="Leave a comment here" id="floatingTextarea2" style="height: 150px"></textarea>
                                                        ...
                                                        <input type="submit" class="btn btn-md  m-1 bg-dark cart-button text-white" value="Send" name="btnreview">
                                                    </form>
                                                </div>
...
$fetch_feedback=$feedback->fetch_feedbacks(@$rows['ProductID']);
while($fetchrow=$fetch_feedback->fetch_assoc()){
?>
                <li>
                                                                <div class="people-box">
                                              
                                                                    <div class="people-comment">
                                                                        <a class="name" href="#"><?php echo $fetchrow["CustomerName"]?></a>
                                                                        <div class="date-time">
                                                                            <h6 class="text-content"><?php echo $fetchrow["feedbackDate"]?>
                                                                                </h6>
                                                                        </div>

                                                                        <div class="reply">
                                                                            <p><?php echo $fetchrow["Feedback"]?>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
}$count=mysqli_num_rows($fetch_feedback);
if($count<=0){
    ?><li> <h2>No reviewed</h2> </li><?php
}
