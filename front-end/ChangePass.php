...
if(@$_POST["updatepass"]){
    ...
    if($pin==$_SESSION["cpin"]){
        $change=$customer->update($_POST["pass"], $_SESSION["cemail"]); 
        if($change){
            echo "Your Password is Successfully Changed!";
            echo "<script>window.location.href='login.php'</script>";
        }else{
            echo "Sorry! Password is not Changed.";
        }
    }else{
        echo "Wronge Pin Code.. Please try again!";
                                ...
                                <form class="row g-4" method="POST">
                                    <div class="col-12">
                                        <div class="form-floating theme-form-floating log-in-form">
                                            ...
                                            <label for="pin">Six Digit Pin Code</label>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <input class="btn btn-animation w-100" type="submit" name="updatepass" value="Change
                                            Password">
                                    </div>
                                </form>
                            </div>
