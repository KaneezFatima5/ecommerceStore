...
<head>
    ...
    <title>Art Shopping - Customer Feedback</title>
    <!-- Google font-->
    <link
                            ...
                            <div class="card card-table">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive table-product">
                                        ...
                                        if(@$_GET["id"]){
                                            if($feed->Deletefeedback($_GET["id"])){
                                                echo "<script> window.location.href='feedback.php'</script>";
                                            }
                                        }

                                        $emp=$feed->Selectfeedback("");
    ...
    ?>
           <ul>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="feedback.php?id=<?php echo $row['FeedbackID']?>" >
