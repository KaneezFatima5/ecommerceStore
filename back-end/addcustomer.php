...
<head>
    ...
    <title>Art Shopping - Add New Customer</title>
...
if(@$_POST["btnSubmit"]){
    if($cus->AddCustomer($_POST["txtcus"],$_POST["txtemail"],$_POST["txtpass"],$_POST["txtcontact"])){
...
<input type="text" class="form-control" name="txtcus" required id="exampleInputEmail1" placeholder="Enter Name">
</div>
<br>
<div class="form-group">
<label for="exampleInputEmail1">Customer Email</label>
<input type="text" class="form-control" name="txtemail" required id="exampleInputEmail1" placeholder="Enter Username">
</div>
<br>
<div class="form-group">
<label for="exampleInputPassword1">Password</label>
<input type="password" class="form-control" name="txtpass" required id="exampleInputPassword1" placeholder="Password">
</div>
</div>
<br>
<div class="form-group">
<label for="exampleInputPassword1">Contact</label>
<input type="text" class="form-control" name="txtcontact" required id="exampleInputPassword1" placeholder="Contact No">
</div>
</div>
