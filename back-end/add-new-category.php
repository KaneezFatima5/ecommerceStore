...
<?php include("aside.php"); ?>
            ...
            if(move_uploaded_file($_FILES["catImage"]["tmp_name"],$path)){
                if($cat->AddCategory($_POST["txtname"],$path)){
                                            ...
                                            <form class="theme-form theme-form-2 mega-form" method="post" enctype="multipart/form-data">
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" required type="text"
                                                            placeholder="Category Name" name="txtname">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    <label class="col-sm-3 col-form-label form-label-title">Category
                                                        ...
                                                        <input type="file" class="form-control" required name="catImage" id="exampleInputEmail1">
                                                    </div>
                                                </div>

                                               <div class="form-group">
                                                <input type="submit" value="Submit" required class="btn btn-success" name="btnsub">
                                               </div>
                                            </form>
                                        </div>
                                    </div>
