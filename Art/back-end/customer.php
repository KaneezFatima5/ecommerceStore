...
<head>
    ...
    <title>Art Shopping - Customer</title>
    <!-- Google font-->
    <link
                                ...
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        ...
                                        <form class="d-inline-flex">
                                            <a href="addcustomer.php" class="align-items-center btn btn-theme d-flex">
                                    ...
                                    <div class="table-responsive table-product">
                                        ...
                                        if(@$_GET["cid"]){
                                            if($cus->DeleteCustomer($_GET["cid"])){
                                                echo "<script> window.location.href='customer.php'</script>";
                                            }
                                        }

                                        $emp=$cus->SelectCustomer(null);
                                        ...
                                        {?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <?php echo $row["CustomerPass"] ?></td>
                                                    ...
                                                    <ul>
                                                            <li>
                                                                <a href="editcustomer.php?id=<?php echo $row['CustomerID'] ?>">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="customer.php?cid=<?php echo $row['CustomerID']?>" >
