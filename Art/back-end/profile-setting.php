                                            ...
                                            <form class="theme-form theme-form-2 mega-form" method="post">
                                                <div class="row">
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text"
                                                                placeholder="Enter Your User Name" name="txtuser">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="email"
                                                                placeholder="Enter Your Last Name" name="txtemail">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="number"
                                                                placeholder="Enter Your Number" name="txtcontact">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="password"
                                                                placeholder="Enter Your Password" name="txtpass">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text"
                                                                placeholder="Enter Your Role" name="txtrole">
                                                        </div>
                                                    </div>
                                                    <div class="mb-4 row align-items-center">
