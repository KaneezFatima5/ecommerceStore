...
<head>
    ...
    <title>Art Shopping - Order List</title>
                            ...
                            <div class="card card-table">
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        <h5>Order List</h5>
                                        <a href="#" class="btn btn-solid">Add New</a>
                                    </div>
                                    <div>
                                                    ...
                                                    while($row=$cus->fetch_assoc()){    
                                                        ...
                                                        <td>
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="editorder.php?id=<?php echo $row["OrderID"]?>">
                                                                        <i class="ri-pencil-line"></i>
                                                                    </a>
                                                                </li>

                                                                <li>
                                                                    <a href="order-list.php?oid=<?php echo $row["OrderID"]?>" data-bs-toggle="modal"
